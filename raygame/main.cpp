...
int main()
{
	...
	Maze::TileKey leftMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, g, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, g, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, _, _, w, w, _, _, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, z, d },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		...
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w, w, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w, w, w },
		{ w, w, w, w, w, w, w, w, _, _, w, w, w, w, w, _, _, _, _, _, _, _, _, _, w, w, w, w },
		{ w, _, _, _, _, _, _, w, _, _, w, _, _, _, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, _, _, g, _, _, _, w, _, w, w, _, _, _, _, _, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, _, _, _, _, _, _, w, _, w, _, _, _, g, _, _, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, _, _, _, _, _, _, w, _, w, _, g, _, _, _, _, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
	};
	...
	//Scene[0] Room Demonstrating AI Decision Tree Ghosts Wander Till Player is near then Seek
